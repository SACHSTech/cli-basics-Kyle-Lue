...
2. create a new directory calunled `CLIBasicsFolder`
...
11. move the `myfile2.txt` the parent directory of `CLIBasicsFolder`
12. list the contents of the parent directory of `CLIBasicsFolder`
